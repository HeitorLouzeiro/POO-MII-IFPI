/* 6) (opcional) O que acontece se você tentar acessar um atributo diretamente na classe? 
Como, por exemplo:
Conta.saldo = 1234;
...
public class Q6 {
    public static void main(String[] args) {      
        ...
        /* Sim, pois o metodo saca está dentro da classe Conta, e o metodo saca e responsável 
